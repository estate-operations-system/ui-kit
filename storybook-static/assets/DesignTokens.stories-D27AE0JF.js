const t={title:"Foundations/Design Tokens",tags:["autodocs"]},s={render:()=>({template:`
    ...
    `,mounted(){if(document.getElementById("design-tokens-story-style"))return;const e=document.createElement("style");e.id="design-tokens-story-style",e.textContent=`
        .tokens-root {
          display: grid;
          gap: var(--eos-space-l);
      ...
      `,document.head.appendChild(e)}})};var o,a,r;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <div class="tokens-root">
        <h2>Цвета</h2>
...
}`,...(r=(a=s.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const i=["VariablesOverview"];export{s as VariablesOverview,i as __namedExportsOrder,t as default};
